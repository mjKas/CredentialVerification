        ...
        database.con.query(query, function (err, resultQuery) {
            if (err) {
                ...
                if (resultQuery.length <= 0) {
                    ...
                    readHTMLFile('/home/manuja2zlato/CredentialVerification/backend/email/registerUser.html', function (err, html) {
                        ...
                        if (err) {
                            ...
                            database.con.query(query, function (err, resultQuery) {
                                if (err) {
                                    ...
                                    readHTMLFile('/home/manuja2zlato/CredentialVerification/backend/email/passwordReset.html', function (err, html) {
                                        let template = handlebars.compile(html);
                                        let replacements = {
                                            url: url
                                        };
            ...
            database.con.query(selectQuery, function (err, resultQuery) {
                if (err) {
                    ...
                    if (resultQuery.length <= 0) {
                        ...
                        readHTMLFile('/home/manuja2zlato/CredentialVerification/backend/email/certificateEmail.html', function (err, html) {
                            let template = handlebars.compile(html);
